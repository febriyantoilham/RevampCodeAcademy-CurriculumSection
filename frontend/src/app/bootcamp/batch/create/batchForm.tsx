            ...
            <div className="col-span-5 flex flex-col gap-5">
              ...
              <div className="flex w-full gap-2 ">
                <div className="flex flex-col w-full">
                    ...
                    <CustomSelect id={'inproEmpEntityId'} options={instructorsOptions} defaultValue={instructorsOptions.find((option: any) => option.value === formik.values.inproEmpEntityId)} onChange={formik.setFieldValue}/>
                </div>
                <div className="flex flex-col w-full">
