...
export default function UserPhonesDeleteModal(props: any) {
    ...
    const onDelete = () => {
        ...
        dispatch(deleteUserPhoneRequest(payload));
        handleChange();
        ...
        <div className="modal modal-bottom sm:modal-middle">
            <div className="modal-box">
                <div className='w-full flex flex-col gap-5'>
                    <h1 className='capitalize'>are you sure delete this number?</h1>
